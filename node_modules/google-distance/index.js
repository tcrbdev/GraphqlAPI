...
GoogleDistance.prototype.get = function (args, callback) {
  ...
  if (self.proxyUrl)
    proxy = { proxy: self.proxyUrl };

  fetchData(options, proxy, function (err, data) {
...
var fetchData = function (options, proxy, callback) {
  // proxiedRequest.get(DISTANCE_API_URL + qs.stringify(options), function (err, res, body) {
